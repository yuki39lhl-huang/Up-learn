# -*- coding: utf-8 -*-
"""抽取山东专升本历年真题 PDF 文本 → sql/phase1/_pdf_extract_sd/"""
from pypdf import PdfReader
from pathlib import Path
import json

root = Path(r"e:\GrammarPractice\IdeaProject\up-learn\shijuan\山东专升本-历年真题")
out_dir = Path(r"e:\GrammarPractice\IdeaProject\up-learn\sql\phase1\_pdf_extract_sd")
...
for s in summaries:
    print(s["file"], s.get("chars"), s.get("pages"), s.get("error", ""))
